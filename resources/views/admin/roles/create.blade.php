...
@section('content')
    ...
    <x-admin.page-title title="Novo grupo" description="Crie um novo grupo de acesso." />
                        ...
                        @foreach ($permissions->flatten() as $permission)
                            ...
                            <label
                                ...
                                <input type="checkbox"
                                    ...
                                    name="permissions[]" value="{{ $permission->name }}" @checked(in_array($permission->name, old('permissions', [])))>
